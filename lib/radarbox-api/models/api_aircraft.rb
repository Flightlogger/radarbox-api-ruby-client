...
module Radarbox
  class ApiAircraft
    ...
    def hash
      [mode_s, registration, type_icao, type_iata, type_description, class_description, company_icao, company_name, first_flight, serial_number, photos, aircraft_statitics].hash
    end
