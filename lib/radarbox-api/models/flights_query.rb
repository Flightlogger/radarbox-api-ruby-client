...
module Radarbox
  class FlightsQuery
    ...
    def hash
      [from_date, to_date, departure_from_date, departure_to_date, arrival_from_date, arrival_to_date, registrations, flight_ids, mode_s_hex_codes, airlines, to_airports, from_airports, include_flight_paths, sources, aircraft_classes].hash
    end
