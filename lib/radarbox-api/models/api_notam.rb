...
module Radarbox
  ...
  class ApiNotam
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'notam_class')
        self.notam_class = attributes[:'notam_class']
      end
    ...
    def hash
      [number, id, notam_class, year, type, effective_start, effective_end, icao_location, issued, affected_fir, minimum_flight_level, maximum_flight_level, radius, location, text, translations].hash
    end
