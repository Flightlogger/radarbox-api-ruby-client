...
module Radarbox
  class ApiFlight
    ...
    attr_accessor :flight_url

    attr_accessor :flight_kml

    attr_accessor :flight_csv

    attr_accessor :flight_geo_json
    ...
    def self.attribute_map
      {
        ...
        :'flight_kml' => :'flightKml',
        :'flight_csv' => :'flightCSV',
        :'flight_geo_json' => :'flightGeoJSON',
        :'status' => :'status'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'flight_url')
        self.flight_url = attributes[:'flight_url']
      end

      if attributes.key?(:'flight_kml')
        self.flight_kml = attributes[:'flight_kml']
      end

      if attributes.key?(:'flight_csv')
        self.flight_csv = attributes[:'flight_csv']
      end

      if attributes.key?(:'flight_geo_json')
        self.flight_geo_json = attributes[:'flight_geo_json']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flight_url == o.flight_url &&
          flight_kml == o.flight_kml &&
          flight_csv == o.flight_csv &&
          flight_geo_json == o.flight_geo_json &&
          status == o.status
    end
